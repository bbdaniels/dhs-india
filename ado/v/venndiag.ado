...
*! Venn Diagram graphs Version 1.02, JM.Lauritsen STB-47/48/49 gr34.2 (stata 5)
...
if "$S_pg" != "y" {
di "*! version 2.11 23nov1999 (extended version, added circles and ellipses)"
di "   please comment to JM.Lauritsen@dadlnet.dk. Changes available by:"
di "   net from http://www.bola.suite.dk"
global S_pg = "y"}
